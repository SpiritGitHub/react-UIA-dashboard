...
import Notifications from './Components/NotificationList/Notification';
...
const serviceInputs = [
  ...
  { id: 3, name: 'telephoneService', type: 'texte', placeholder: 'Telephone du Service', section: 'service'},
  { id: 4, name: 'nomCompletAdmin', type: 'text', placeholder: 'Nom Complet de l\'Admin', section: 'admin' },
  { id: 5, name: 'emailAdmin', type: 'email', placeholder: 'Email de l\'Admin', section: 'admin' },
  { id: 6, name: 'telAdmin', type: 'tel', placeholder: 'Téléphone de l\'Admin', section: 'admin' },
];
